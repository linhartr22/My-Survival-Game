...
// Stop camera from leaving room.
if (cam_follow_x < 0) {cam_follow_x = 0;}
if (cam_follow_y < 0) {cam_follow_y = 0;}
if (cam_follow_x + cam_width > room_width) cam_follow_x = room_width - cam_width;
if (cam_follow_y + cam_height > room_height) cam_follow_y = room_height - cam_height;
